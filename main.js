...
{
	if (region.a8.aw === region.br.aw)
	{
		return 'on line ' + region.a8.aw;
	}
	return 'on lines ' + region.a8.aw + ' through ' + region.br.aw;
}
...
var $author$project$Styling$subtitlize = function (x) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$p,
		_List_fromArray(
			[
				$rtfeldman$elm_css$Html$Styled$Attributes$class('subtitle')
			]),
		_List_fromArray(
			[
...
var $author$project$ProfessionalPage$interestsParagraph = A2(
	...
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Some more topics that I enjoy and am very invested in are listed down below:')
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$id('interestLists')
				]),
			_List_fromArray(
				[
					A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('Mathematics')
										]))
								])),
							A2(
							$author$project$Styling$listify,
							$rtfeldman$elm_css$Html$Styled$ul(_List_Nil),
							_List_fromArray(
								['Calculus', 'Higher Order Logic', 'Number Theory', 'Abstract Algebra', 'Incompleteness', 'Topology', 'Symbolic Mathematics']))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_Nil,
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$text('Computer Science')
										]))
								])),
							A2(
							$author$project$Styling$listify,
							$rtfeldman$elm_css$Html$Styled$ul(_List_Nil),
							_List_fromArray(
								['Programming Language Design', 'Models of Computation', 'Automated Theorem Proving', 'Computer Architecture', 'Machine Learning', 'Data Compression', 'Formal Languages']))
						]))
				]))
		]));
var $author$project$ProfessionalPage$methodologyParagraph = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$id('methodology'),
			$rtfeldman$elm_css$Html$Styled$Attributes$class('info')
		]),
	_List_fromArray(
		[
			$author$project$Styling$subtitlize('Methodology Of Programming:'),
			A2(
			$rtfeldman$elm_css$Html$Styled$p,
			_List_Nil,
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$text('Naturally, as I have stated in my Approach to Problem Solving segment, I prefer a functional paradigm to programming. I believe that reducing the amount of states that I have to keep track of while coding gives me the safest and most efficient code. It is also intuitive to me since it makes all of the axioms and core definitions more apparent, whereas an object oriented approach requires me to interpret and build on composite definitions (for example, an encapsulating class in java). With that said, a functional approach isn’t the only and end all approach to me. I find myself using procedural programming when I want to work closer with the hardware or want to decrease the amount of memory I use or the processing time it takes to complete a task. Furthermore, I have traditionally used object oriented programming for a lot of my past projects.')
				]))
		]));
var $author$project$ProfessionalPage$otherInfo = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_fromArray(
		[
			$rtfeldman$elm_css$Html$Styled$Attributes$id('other'),
			$rtfeldman$elm_css$Html$Styled$Attributes$class('info')
		]),
	_List_fromArray(
		[
			...
			_List_fromArray(
				[
					$rtfeldman$elm_css$Html$Styled$Attributes$class('flexIt')
				]),
			_List_fromArray(
				[
					A2(
					...
					_List_fromArray(
						[
							$author$project$Styling$subtitlize('Professional Skills:'),
							A2(
							$author$project$Styling$listify,
							$rtfeldman$elm_css$Html$Styled$ul(_List_Nil),
							_List_fromArray(
								['Time Managment', 'Organization', 'Group Communication', 'Problem Solving', 'Adaptability', 'Self Motivation']))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_Nil,
					_List_fromArray(
						[
							$author$project$Styling$subtitlize('Programming Languages & Frameworks:'),
							A2(
							$author$project$Styling$listify,
							$rtfeldman$elm_css$Html$Styled$ul(_List_Nil),
							_List_fromArray(
								['Python', 'Javascript', 'Java', 'C#', 'OCaml', 'Elm', 'MIPS Assembly', 'React.js', 'Express.js', 'Node.js', '.NET Framework']))
						]))
				])),
			A2(
			$rtfeldman$elm_css$Html$Styled$div,
			...
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$author$project$Styling$subtitlize('Mathematical Concepts & Theories'),
							A2(
							$author$project$Styling$listify,
							$rtfeldman$elm_css$Html$Styled$ul(_List_Nil),
							_List_fromArray(
								['Discrete Mathematics', 'Differential Calculus', 'Integral Calculus', 'Multivariable Calculus', 'Untyped Lambda Calculus', 'Linear Algebra', 'Graph Theory', 'Combinatorics', 'Discrete Transforms', 'Propositional/Predicate Logic', 'Proof Techniques', 'Boolean Algebra', 'Statistical Hypothesis Testing', 'Probability Distributions', 'Category Theory']))
						])),
					A2(
					$rtfeldman$elm_css$Html$Styled$div,
					_List_Nil,
					_List_fromArray(
						[
							$author$project$Styling$subtitlize('Programming Paradigms & Concepts:'),
							A2(
							$author$project$Styling$listify,
							$rtfeldman$elm_css$Html$Styled$ul(_List_Nil),
							_List_fromArray(
								['Object-Oriented Programming', 'Functional Programming', 'Data Structures', 'Computational Complexity', 'Non/Deterministic Automata', 'Context-Free Grammar', 'Unrestricted Grammar', 'Greedy Algorithms', 'Divide & Conquer Algorithms', 'Dynamic Programming']))
						]))
				]))
		]));
var $author$project$ProfessionalPage$professionalContent = A2(
	$rtfeldman$elm_css$Html$Styled$div,
	_List_Nil,
	_List_fromArray(
		[$author$project$ProfessionalPage$interestsParagraph, $author$project$ProfessionalPage$careerGoalsParagraph, $author$project$ProfessionalPage$approachParagraph, $author$project$ProfessionalPage$methodologyParagraph, $author$project$ProfessionalPage$otherInfo]));
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{
			bo: $author$project$ProfessionalPage$professionalContent,
			L: {aL: 0, a$: 0, bb: 0},
			ay: 'professional',
			aU: 0
		},
...
var $author$project$Main$resize = _Platform_incomingPort(
	'resize',
	A2(
					...
					return A2(
						...
						function (height) {
							return $elm$json$Json$Decode$succeed(
								{aL: height, a$: maxHeight, bb: width});
						},
						A2($elm$json$Json$Decode$field, 'height', $elm$json$Json$Decode$int));
				},
				A2($elm$json$Json$Decode$field, 'maxHeight', $elm$json$Json$Decode$int));
		},
		A2($elm$json$Json$Decode$field, 'width', $elm$json$Json$Decode$int)));
var $author$project$Main$scroller = _Platform_incomingPort('scroller', $elm$json$Json$Decode$int);
var $author$project$Main$subscriptions = function (_v0) {
	return $elm$core$Platform$Sub$batch(
		_List_fromArray(
			[
				$author$project$Main$scroller($author$project$Main$Scroll),
				$author$project$Main$resize($author$project$Main$Resize)
			]));
};
var $elm$core$String$cons = _String_cons;
var $robinheghan$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {Y: charsProcessed, ad: hash, S: seed, ai: shift};
	});
...
var $robinheghan$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.ad)) ? (data.S ^ A2(
		$robinheghan$murmur3$Murmur3$multiplyBy,
		$robinheghan$murmur3$Murmur3$c2,
		A2(
			$robinheghan$murmur3$Murmur3$rotlBy,
			15,
			A2($robinheghan$murmur3$Murmur3$multiplyBy, $robinheghan$murmur3$Murmur3$c1, data.ad)))) : data.S;
	var h0 = acc ^ data.Y;
	...
	function (c, data) {
		...
		if (_v0 === 24) {
			return {
				Y: data.Y + 1,
				ad: 0,
				S: A2($robinheghan$murmur3$Murmur3$mix, data.S, res),
				ai: 0
			};
		} else {
			return {Y: data.Y + 1, ad: res, S: data.S, ai: data.ai + 8};
		}
	});
...
var $author$project$Dragon$F = 0;
var $author$project$Main$Personal = {$: 1};
var $author$project$Main$Professional = {$: 0};
...
var $author$project$Main$onPageDo = F3(
	function (model, task1, task2) {
		return (model.ay === 'professional') ? task1 : task2;
	});
...
var $author$project$Styling$theme = {
	a5: $rtfeldman$elm_css$Css$hex('6006DA'),
	ch: $rtfeldman$elm_css$Css$hex('4EF5C9'),
	ck: $rtfeldman$elm_css$Css$hex('000000'),
	a6: $rtfeldman$elm_css$Css$hex('00E1B0'),
	cm: $rtfeldman$elm_css$Css$hex('000000')
};
var $author$project$Main$backgroundColor = F2(
	function (model, invert) {
		var alteredTheme = invert ? _Utils_update(
			$author$project$Styling$theme,
			{a5: $author$project$Styling$theme.a6, a6: $author$project$Styling$theme.a5}) : $author$project$Styling$theme;
		return A3($author$project$Main$onPageDo, model, alteredTheme.a5, alteredTheme.a6);
	});
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	var charset = _v0.bn;
	var imports = _v0.bw;
	var namespaces = _v0.bB;
	var declarations = _v0.b2;
	return {
		bn: charset,
		b2: $rtfeldman$elm_css$Css$Structure$compactDeclarations(declarations),
		bw: imports,
		bB: namespaces
	};
};
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bn: charset, b2: declarations, bw: imports, bB: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bn: $elm$core$Maybe$Nothing, bw: _List_Nil, bB: _List_Nil, bO: snippets};
};
...
var $author$project$Dragon$G = 1;
var $author$project$Dragon$Left = 3;
var $author$project$Dragon$Right = 2;
...
var $author$project$Dragon$expand = function (curve) {
	var _v0 = $elm$core$List$head(curve);
	if (!_v0.$) {
		switch (_v0.a) {
			case 0:
				var _v1 = _v0.a;
				return _Utils_ap(
					_List_fromArray(
						[0, 3, 1]),
					$author$project$Dragon$expand(
						A2($elm$core$List$drop, 1, curve)));
			case 1:
				var _v2 = _v0.a;
				return _Utils_ap(
					_List_fromArray(
...
var $author$project$Dragon$expandOut = F2(
	function (n, curve) {
		expandOut:
		while (true) {
			if (n <= 0) {
				...
				var $temp$n = n - 1,
					$temp$curve = $author$project$Dragon$expand(curve);
				n = $temp$n;
				curve = $temp$curve;
				continue expandOut;
			}
...
var $author$project$Styling$initCanvas = F3(
	function (canvasId, w, h) {
		return $rtfeldman$elm_css$Svg$Styled$svg(
			_List_fromArray(
				[
					...
					$rtfeldman$elm_css$Svg$Styled$Attributes$id(canvasId)
				]));
	});
...
var $author$project$Styling$canvasLine = F5(
	function (c, x, y, dx, dy) {
		return A2(
...
var $author$project$Dragon$renderDragon = F6(
	function (c, curve, x, y, theta, l) {
		renderDragon:
		while (true) {
			var iterLine = A5(
				$author$project$Styling$canvasLine,
				c,
				x,
				y,
				$elm$core$Basics$cos(
					$elm$core$Basics$degrees(theta)) * l,
				$elm$core$Basics$sin(
					$elm$core$Basics$degrees(theta)) * l);
			var _v0 = $elm$core$List$head(curve);
			if (!_v0.$) {
				switch (_v0.a) {
					case 0:
						...
						return A2(
							...
							iterLine,
							A6(
								$author$project$Dragon$renderDragon,
								c,
								A2($elm$core$List$drop, 1, curve),
					...
					case 2:
						var _v3 = _v0.a;
						var $temp$c = c,
							$temp$curve = A2($elm$core$List$drop, 1, curve),
							$temp$x = x,
							$temp$y = y,
							$temp$theta = theta - 90.0,
							$temp$l = l;
						c = $temp$c;
						curve = $temp$curve;
						x = $temp$x;
...
var $author$project$Dragon$dragonCanvas = F5(
	function (c, curve, n, w, h) {
		return (!n) ? A4(
			$author$project$Styling$initCanvas,
			'dragonCurve',
			w,
			h,
			A6($author$project$Dragon$renderDragon, c, _List_Nil, 0.0, 0.0, 0.0, 0.0)) : A4(
			$author$project$Styling$initCanvas,
			'dragonCurve',
			w,
			h,
			A6(
				$author$project$Dragon$renderDragon,
				c,
				A2($author$project$Dragon$expandOut, n, curve),
				w / 2,
				h / 4,
				0.0,
				h / 50));
			...
			[
				...
				_List_fromArray(
					[
						...
						A2($author$project$Main$backgroundColor, model, false))
					]))
			]),
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						$rtfeldman$elm_css$Html$Styled$text('Nathan Carlson\'s Portfolio')
					])),
				A2(
				$rtfeldman$elm_css$Html$Styled$div,
				_List_fromArray(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$id('sidebar')
							]),
						_List_Nil),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$id('content')
							]),
						_List_fromArray(
							[$author$project$Main$quickBio, $author$project$ProfessionalPage$professionalContent])),
						A2(
						$rtfeldman$elm_css$Html$Styled$div,
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$Attributes$id('pageInteractives')
							]),
						_List_fromArray(
							[
								A2(
								...
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$Attributes$id('mode'),
										$rtfeldman$elm_css$Html$Styled$Attributes$css(
										_List_fromArray(
											[
												$rtfeldman$elm_css$Css$backgroundColor(
												A2($author$project$Main$backgroundColor, model, true))
											])),
										A3(
										$author$project$Main$onPageDo,
										model,
										$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Personal),
										$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Professional))
									]),
								_List_fromArray(
									[
										$rtfeldman$elm_css$Html$Styled$text('Professional')
									]))
							])),
						A5(
						$author$project$Dragon$dragonCanvas,
						A3($author$project$Main$onPageDo, model, '#880088', '#008888'),
						_List_fromArray(
							[0]),
						$elm$core$Basics$round((10 * model.aU) / (model.L.a$ - model.L.aL)),
						model.L.bb,
						model.L.aL)
					]))
			]));
...
var $author$project$Main$main = $elm$browser$Browser$element(
	{
		...
		cl: $author$project$Main$subscriptions,
		co: $author$project$Main$update,
		cq: A2($elm$core$Basics$composeR, $author$project$Main$view, $rtfeldman$elm_css$Html$Styled$toUnstyled)
	});
